#ifndef VIRTUAL_LAYER_VIRTUAL_LAYER_H_
#define VIRTUAL_LAYER_VIRTUAL_LAYER_H_
...
#include "virtual_layer/VirtualLayerConfig.h"
...
#endif //VIRTUAL_LAYER_VIRTUAL_LAYER_H_
